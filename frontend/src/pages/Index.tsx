          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mt-2">
                Get help, browse FAQs, contact support, or share your feedback.
              </p>

              <button
                onClick={() => setShowSupport(true)}
                className="mt-4 w-full bg-blue-500 text-white py-2.5 rounded-lg text-sm font-medium hover:bg-blue-600 transition-colors"
              >
                Open Help Center
              </button>
            </div>
